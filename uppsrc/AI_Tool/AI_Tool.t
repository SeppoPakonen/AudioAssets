...
T_("Biography:")
fiFI("El\303\244m\303\244nkerta:")

T_("Musical style:")
fiFI("Musiikkityyli:")

T_("Vibe of voice:")
fiFI("\303\204\303\244nen tunnelma:")

T_("Acoustic instr.:")
fiFI("Akustinen soitin:")
...
fiFI("Odotusten kumoaminen")

T_("Absurd Concepts")
fiFI("Absurdeja k\303\244sitteit\303\244")

T_("Juxtaposition")
fiFI("Vastakkainasettelu")

T_("Unexpected Combinations")
fiFI("Odottamattomia yhdistelmi\303\244")

T_("Repetition of Unusual Themes")
fiFI("Ep\303\244tavallisten teemojen toistoa")

T_("Props and Characters that are Unusual")
fiFI("Rekvisiitta ja hahmot, jotka ovat ep\303\244tavallisia")

T_("Utilization of Unconventional Format")
fiFI("Ep\303\244tavanomaisen muodollisuuden k\303\244ytt\303\266")

T_("Incongruous Settings and Environments")
fiFI("Sopimattomat asetelmat ja ymp\303\244rist\303\266t")

T_("Flips of Gender Roles")
fiFI("Sukupuoliroolien k\303\244\303\244nteisyys")

T_("Flips of Social Constructs")
fiFI("Sosiaalisten rakenteiden k\303\244\303\244nteisyys")

T_("Incongruous Pairings of Opposites")
fiFI("Sopimattomat vastakohtien parit")
...
fiFI("Keskin\303\244inen antagonismi")

T_("Negligent ia. with God")
fiFI("Piittaamattomuus Jumalalle")

T_("Mechanical/Workaround ia. with God")
fiFI("Huijausyritys Jumalalle")

T_("Transcendental ia. with God ")
fiFI("Yliluonnollisuus Jumalalle")

T_("Devotional ia. with God")
fiFI("Hartaus Jumalan kanssa")

T_("Conversational ia. with God")
fiFI("Keskustelua Jumalan kanssa")

T_("Parental ia. with God")
fiFI("Vanhemmuudesta Jumalan kanssa")

T_("Playful ia. with Personified Deities ")
fiFI("Leikkisyys persoona-ylimyksill\303\244")

T_("Quasi-Moral Behavioural ia. ")
fiFI("Eettisyys peitetty moralismina")

T_("Judgmental ia. with God ")
fiFI("Tuomitsevuutta Jumalan kanssa")

T_("Confrontational ia. with God ")
fiFI("Vastakkainasettelua Jumalaan")

T_("Sympathetic ia. with God ")
fiFI("Sympaattisuus Jumalalle")

T_("Reverential ia. with God")
fiFI("Kunnioittavaa Jumalalle")

T_("Playful ia. with Angels")
fiFI("Leikkis\303\244\303\244 enkeleille")

T_("Oblivious ia. with Angels")
fiFI("Huomaamattomuus enkeleille")

T_("Trustful ia. with Angels ")
fiFI("Luottavaisuus enkeleille")

T_("Supernatural ia. with Angels ")
fiFI("Yliluonnollisuus enkeleille")

T_("Playful ia. with Spirits ")
fiFI("Leikkisyys hengille")

T_("Playful ia. with the Dead ")
fiFI("Leikkisyys kuolleille")

T_("Playful ia. with Nature")
fiFI("Leikkisyys luonnolle")

T_("Conflict ia. with Animals ")
fiFI("Konflikti el\303\244imille")

T_("Mutual Respect ia. with Animals ")
fiFI("Yhteinen kunnioitus el\303\244imille")
...
T_("Business")
fiFI("Liiketoiminnallinen")

T_("Political")
fiFI("Poliittinen")

T_("Cultural")
fiFI("Kulttuurillinen")

T_("Emotional")
fiFI("Tunteellinen")

T_("Intellectual")
fiFI("\303\204lyllinen")
...
T_("path in forest")
fiFI("polku mets\303\244ss\303\244")
...
T_("seductive")
fiFI("viettelev\303\244")

T_("devious")
fiFI("kavala")

T_("mysterious")
fiFI("salaper\303\244inen")
...
T_("Bittersweet")
fiFI("Katkeransuloinen")

T_("Desperate")
fiFI("Ep\303\244toivoinen")
...
T_("mellow")
fiFI("t\303\244ytel\303\244inen")
...
T_("Physical Comedy")
fiFI("Fyysinen komedia")

T_("Tragedy Mocks Success")
fiFI("Tragedia pilkkaa menestyst\303\244")

T_("Self-Deprecation")
fiFI("Itse-v\303\244h\303\244ttely")

T_("Deadpan Humor")
fiFI("Kuollut huumori")

T_("Satire")
fiFI("Satiiri")

T_("Working Against Cliche")
fiFI("Ty\303\266skentelee kliseit\303\244 vastaan")

T_("Repetitive Actions and Situations")
fiFI("Toistuvat toiminnot ja tilanteet")
...
fiFI("Kommunikaatiovirhe ja sanapelit")

T_("Parody")
fiFI("Parodia")

T_("Quirky Characters")
fiFI("Omituisia hahmoja")

T_("Social Commentary")
fiFI("Sosiaalinen kommentti")

T_("Absurd Dialogue")
fiFI("Absurdi Dialogi")

T_("Playing With Expectations")
fiFI("Odotuksilla leikkiminen")

T_("Silliness")
fiFI("Tyhmyys")

T_("tragic death")
fiFI("traaginen kuolema")

T_("a marriage in crisis")
fiFI("avioliitto kriisiss\303\244")

T_("a serious illness")
fiFI("vakava sairaus")

T_("a family in deep debt")
fiFI("syv\303\244ss\303\244 velassa oleva perhe")

T_("a crime")
fiFI("rikos")

T_("a personal betrayal")
fiFI("henkil\303\266kohtainen petos")

T_("a difficult decision")
fiFI("vaikea p\303\244\303\244t\303\266s")

T_("an addiction")
fiFI("riippuvuus")

T_("a forbidden romance")
fiFI("kielletty romanssi")

T_("a risk")
fiFI("riski")

T_("a moral dilemma")
fiFI("moraalinen dilemma")

T_("conflicts between cultures")
fiFI("kulttuurien v\303\244lisi\303\244 konflikteja")

T_("political unrest")
fiFI("poliittinen levottomuus")

T_("a character's inner struggle")
fiFI("hahmon sis\303\244inen kamppailu")

T_("a redemption story")
fiFI("lunastustarina")

T_("racism and discrimination")
fiFI("rasismia ja syrjint\303\244\303\244")

T_("embracing fate")
fiFI("kohtalon haltuunotto")

T_("facing mortality")
fiFI("kuolevaisuuden edess\303\244")
...
T_("Play-on-Words")
fiFI("Leikkimist\303\244 sanoilla")
...
T_("Sight Gags")
fiFI("Visuaalinen vitsi")

T_("Fish-Out-of-Water")
fiFI("Kala-maalla")

T_("Hammy Acting")
fiFI("Ylin\303\244yttely")
...
fiFI("Ironisia lausuntoja")

T_("Romantic Humor")
fiFI("Romanttista huumoria")

T_("Sexual Humor")
fiFI("Seksuaalista")

T_("Self-Deprecating Humor")
fiFI("Itse\303\244 v\303\244h\303\244ttelev\303\244\303\244 huumoria")

T_("Dark Humor")
fiFI("Pime\303\244\303\244 huumoria")

T_("Casual and Conversational Tone")
fiFI("Rento ja keskusteleva s\303\244vy")

T_("Mockery Humor")
fiFI("Pilkkaavaa huumoria")

T_("Self-Mockery Humor")
fiFI("Itse\303\244 pilkkaavaa huumoria")

T_("Facetiousness")
fiFI("Hauska nokkelana")
...
T_("Surreal Humor")
fiFI("Surreaalista huumoria")

T_("Absurdist Humor")
fiFI("Absurdia huumoria")

T_("One-liners")
fiFI("Yksirivinen")

T_("Smartassery")
fiFI("N\303\244s\303\244viivasus")

T_("Exaggeration")
fiFI("Liioittelu")

T_("Mustache Twirling")
fiFI("Viikset py\303\266riv\303\244t")
...
T_("Contrast and Unexpected Elements")
fiFI("Kontrasti ja odottamattomat elementit")
...
T_("(Interactions) with")
fiFI("(Vuorovaikutukset) kanssa")

T_("Acting Styles")
fiFI("N\303\244yttelij\303\244tyylit")

T_("Tones")
fiFI("S\303\244vyt")

T_("Types of dramatic scenarios")
fiFI("Dramaattisten skenaarioiden tyypit")

T_("Voiceover Tones")
fiFI("Selostuksen s\303\244vyt")

T_("Comedic sentences")
fiFI("Komediset lauseet")

T_("Comedic scenarios")
